...
Inputs (paths relative to this folder)
  outputs/province_ITL.csv                                  (from compute_itl.py)
  inputs/transmission_v2_2021_MODEL_TEMPLATE.csv            (schema + distance/cost template)
  inputs/gist_data_newest/results/results_by_voltage/hvdc_lines.csv  (DC links, added on top)
...
TMPL = HERE / "inputs/transmission_v2_2021_MODEL_TEMPLATE.csv"
ITLCSV = HERE / "outputs/province_ITL.csv"
HVDCCSV = HERE / "inputs/gist_data_newest/results/results_by_voltage/hvdc_lines.csv"
...
def main():
    ...
    write(HERE / "outputs/transmission_v2_2021_ITL_oneway.csv", oneway)
    write(HERE / "outputs/transmission_v2_2021_ITL_bidir.csv", bidir)
